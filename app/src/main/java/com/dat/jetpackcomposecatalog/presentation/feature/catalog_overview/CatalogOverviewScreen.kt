package com.dat.jetpackcomposecatalog.presentation.feature.catalog_overview
...
import com.dat.jetpackcomposecatalog.presentation.feature.CatalogComposeGroup
...
import com.dat.jetpackcomposecatalog.presentation.widget.LotteAnimInfinityLoader
            ...
            CatalogComposeGroup.Layout -> {
                ...
                LotteAnimInfinityLoader(
                    ...
                    if (LocalIsDarkMode.current)
                        R.raw.anim_layout_dark
                    else
                        R.raw.anim_layout_light
                )
            }
