...
import com.dat.jetpackcomposecatalog.presentation.theme.BlackCodeColor
...
import com.dat.jetpackcomposecatalog.presentation.theme.OrangeCodeColor


@Composable
fun <T> SettingComponent(
    modifier: Modifier = Modifier,
    name: String = "",
    settingSelected: T,
    listSetting: List<T> = listOf(),
    mapName: (T) -> String = { "" },
    onSettingSelected: (T) -> Unit = {}
) {
