...
val tabItems = listOf(
    MainTabItem(R.drawable.ic_tab_discover, R.string.tab_catalog, Screen.CatalogOverviewScreen),
    MainTabItem(R.drawable.ic_tab_home, R.string.tab_home, Screen.HomeScreen),
    MainTabItem(R.drawable.ic_tab_user, R.string.tab_user, Screen.UserScreen)
)
